...
http://222.236.46.45/nfsdb/NOAA/2012/07/24/L2/2012.0724.0342.noaa-19.sst.asc.zip
...
file_name = "AVHRR_SST_filenames.txt"
...
for line in lines[:] :
    ...
    if line[-4:] == ".zip" :
        ...
        urls += "{0}{1}{2}/{3}/{4}/L2/{5}\n".\
            format(url1, url2, \
            filename_el[0], filename_el[1][:2], filename_el[1][2:], line)
